 ...
 * Practical Usage:
 * ---------------
 * 1.	Typically singletons are used for global configuration. The simplest example would be 
 * 		LogManager.getLogManager() method, and a single global instance is used. 
 * 2.	Utility layers which consist of Loggging, Caching, Service host repositories, Load Balancer.
 * 
 */
